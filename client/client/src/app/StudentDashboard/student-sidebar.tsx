...
const features = [
  ...
  { name: "Logout", path: "#" },  // Changed to # for handling with onClick
];
...
const StudentSidebar = () => {
            ...
            >
              {feature.name === "Logout" ? (
                <button
                  ...
                  className={`block w-full text-left px-4 py-2 rounded-lg font-medium transition-colors duration-200 hover:shadow-lg hover:bg-white/20 hover:text-cyan-200`}
                ...
                <Link
                  ...
                  className={`block px-4 py-2 rounded-lg font-medium transition-colors duration-200 hover:shadow-lg ${isActive ? "bg-white/20 text-cyan-200 font-bold shadow-lg ring-2 ring-cyan-300" : ""}`}
                  style={{ boxShadow: "0 2px 8px rgba(0,0,0,0.08)" }}
                >
                  {feature.name}
                </Link>
  ...
  // Update the sidebar content to handle logout
